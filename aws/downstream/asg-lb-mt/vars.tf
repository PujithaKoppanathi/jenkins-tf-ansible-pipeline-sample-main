...
variable "load_balancers" {
  ...
  default     = {
    lb-1 = {
      target_groups = [{
        name = "altestlb-dl-broker-in-pga"
        backend_protocol = "tcp"
        backend_port = 7363
        target_type = "instance"
        ...
        health_check = {
          ...
          unhealthy_threshold = 3}},
        {
        name = "altestlb-dl-broker-in-pgb"
        backend_protocol = "tcp"
        backend_port = 7364
        target_type = "instance"
        deregistration_delay = "60"
    ...
    lb-2 = {
      target_groups = [{
        name = "altestlb-dl-broker-out-pga"
        backend_protocol = "tcp"
        backend_port = 6363
        target_type = "instance"
        deregistration_delay = "60"
        health_check = {
          ...
          unhealthy_threshold = 3}},
        {
        name = "altestlb-dl-broker-out-pgb"
        backend_protocol = "tcp"
        backend_port = 6364
        target_type = "instance"
        deregistration_delay = "60"
...
variable "scaleset_prefix" {
  ...
  type        = string
  default     = "template-quotes-asg-test"
}
