...
variable "tg_htl_port" {
  description = "VPC id where the load balancer and other resources will be deployed."
  type        = string
  default     = null
}

variable "tg_htl_protocol" {
  description = "VPC id where the load balancer and other resources will be deployed."
  type        = string
  default     = null
}

variable "tg_htl_redir_path" {
  description = "VPC id where the load balancer and other resources will be deployed."
  type        = string
  default     = null
}

variable "tg_htl_redir_host" {
  description = "VPC id where the load balancer and other resources will be deployed."
  type        = string
  default     = null
}

variable "tg_htl_redir_query" {
  description = "VPC id where the load balancer and other resources will be deployed."
  type        = string
  default     = null
}

variable "tg_htl_fixed_content" {
  description = "VPC id where the load balancer and other resources will be deployed."
  type        = string
  default     = null
}

variable "tg_htl_fixed_message" {
  description = "VPC id where the load balancer and other resources will be deployed."
  type        = string
  default     = null
}

variable "tg_htl_fixed_statcode" {
  description = "VPC id where the load balancer and other resources will be deployed."
  type        = string
  default     = null
}

variable "tg_htl_redir_port" {
  description = "VPC id where the load balancer and other resources will be deployed."
  type        = string
  default     = null
}
variable "tg_htl_redir_protocol" {
  description = "VPC id where the load balancer and other resources will be deployed."
  type        = string
  default     = null
}

variable "tg_htl_action" {
  description = "VPC id where the load balancer and other resources will be deployed."
  type        = string
  default     = null
}
...
variable "tg_proxy_protocol_v2" {
  description = "VPC id where the load balancer and other resources will be deployed."
  type        = bool
  default     = false
}

variable "tg_hc_enabled" {
  description = "VPC id where the load balancer and other resources will be deployed."
  type        = bool
  default     = true
}
